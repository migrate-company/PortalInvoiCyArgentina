...
Para más detalles sobre cómo realizar la autenticación y obtener los tokens de acceso necesarios, consulte la documentación completa de [Autenticación API Rest](https://migrate-company.github.io/PortalInvoiCyArgentina/Integraci%C3%B3n/AutenticacionAPIRest.html){target="_blank"}.
